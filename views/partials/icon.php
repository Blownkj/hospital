<?php
/**
 * Inline SVG icon partial (Lucide icons, MIT).
 * Usage: <?php include 'partials/icon.php'; icon('calendar', 20, 'icon'); ?>
 * Or via helper: View::icon('calendar', ['size' => 20, 'class' => 'icon--muted'])
 */

if (!function_exists('icon')) {
    function icon(string $name, int $size = 20, string $class = 'icon'): void
    {
        static $icons = [
            ...
            'user-round' => '<circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/>',
            'stethoscope' => '<path d="M4.8 2.3A.3.3 0 1 0 5 2H4a2 2 0 0 0-2 2v5a6 6 0 0 0 6 6 6 6 0 0 0 6-6V4a2 2 0 0 0-2-2h-1a.2.2 0 1 0 .3.3"/><path d="M8 15v1a6 6 0 0 0 6 6v0a6 6 0 0 0 6-6v-4"/>',
            ...
            'flower' => '<circle cx="12" cy="12" r="3"/><path d="M12 2a3 3 0 0 0 3 3 3 3 0 0 0-3 3 3 3 0 0 0-3-3 3 3 0 0 0 3-3M6.6 16.4A3 3 0 0 0 9 19.8a3 3 0 0 0 .6-4.2M17.4 16.4A3 3 0 0 1 15 19.8a3 3 0 0 1-.6-4.2M6.6 7.6A3 3 0 0 1 9 4.2a3 3 0 0 1 .6 4.2M17.4 7.6A3 3 0 0 0 15 4.2a3 3 0 0 0-.6 4.2"/>',
            ...
            'brain' => '<path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"/><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4"/><path d="M17.599 6.5a3 3 0 0 0 .399-1.375M6.003 5.125A3 3 0 0 0 6.401 6.5M3.477 10.896a4 4 0 0 1 .585-.396M19.938 10.5a4 4 0 0 1 .585.396M6 18a4 4 0 0 1-1.967-.516M19.967 17.484A4 4 0 0 1 18 18"/>',
            ...
            'calendar-plus' => '<path d="M8 2v4M16 2v4M3 10h18M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z"/><path d="M12 14v4M10 16h4"/>',
        ...
        $path = $icons[$name] ?? '<circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/>';
